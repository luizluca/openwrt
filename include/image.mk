...
define Device/Build/initramfs
  ...
  ifdef TARGET_PER_DEVICE_ROOTFS
    # FIXME: I need to avoid these targets to run in parallel with each other without disabling it completely
    .NOTPARALLEL:

    $(KDIR)/$$(KERNEL_INITRAMFS_NAME).$$(ROOTFS_ID/$(1)):: image_prepare target-dir-$$(ROOTFS_ID/$(1)) $(STAGING_DIR_HOST)/bin/flock
