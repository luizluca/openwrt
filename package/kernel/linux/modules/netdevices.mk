...
define KernelPackage/dsa-realtek-common
  SUBMENU:=$(NETWORK_DEVICES_MENU)
  TITLE:=Realtek common module RTL83xx DSA switch family
  DEPENDS:=@LINUX_6_1 +kmod-dsa +kmod-phy-realtek
  KCONFIG:= \
	CONFIG_NET_DSA_REALTEK \
	CONFIG_NET_DSA_REALTEK_MDIO=y \
	CONFIG_NET_DSA_REALTEK_SMI=y
  FILES:= $(LINUX_DIR)/drivers/net/dsa/realtek/realtek_common.ko
endef

define KernelPackage/dsa-realtek-common/description
  Common kernel module for Realtek RTL83xx DSA switch family
endef

$(eval $(call KernelPackage,dsa-realtek-common))


define KernelPackage/dsa-rtl8366rb
  SUBMENU:=$(NETWORK_DEVICES_MENU)
  TITLE:=Realtek RTL8365MB switch DSA support
  DEPENDS:=+kmod-dsa-realtek-common +kmod-regmap-core @LINUX_6_1
  KCONFIG:= \
  ...
  AUTOLOAD:=$(call AutoLoad,42,tag_rtl4_a rtl8366,1)
endef
...
define KernelPackage/dsa-rtl8365mb
  ...
  AUTOLOAD:=$(call AutoLoad,42,tag_rtl8_4 rtl8365mb,1)
endef
