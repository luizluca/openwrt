...
define Device/tplink_archer-a7-v5
  ...
  DEVICE_PACKAGES := kmod-usb2 kmod-usb-ledtrig-usbport kmod-ath10k-ct \
	ath10k-firmware-qca988x-ct -kmod-switch-ip17xx -kmod-switch-ar8xxx \
	kmod-switch-qca8k -swconfig -kmod-swconfig
...
define Device/tplink_archer-c7-v4
  ...
  DEVICE_PACKAGES := kmod-usb2 kmod-usb-ledtrig-usbport kmod-ath10k-ct \
	ath10k-firmware-qca988x-ct -kmod-switch-ip17xx -kmod-switch-ar8xxx \
	kmod-switch-qca8k -kmod-swconfig -swconfig
...
define Device/tplink_tl-wdr3600-v1
  ...
  DEVICE_VARIANT := v1
  DEVICE_PACKAGES := kmod-usb2 kmod-usb-ledtrig-usbport -kmod-switch-ip17xx\
		     -kmod-switch-ar8xxx kmod-switch-qca8k -swconfig -kmod-swconfig
